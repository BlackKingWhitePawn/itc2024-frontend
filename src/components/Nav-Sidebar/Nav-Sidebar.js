    ...
    return (
        <div className="sidebar-container">
            <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
                ...
                <Traffic onClick={() => setChosen(1)} style={{ alignSelf: "center", backgroundColor: chosen == 1 ? "#ccf" : "#fff", borderRadius: "20px", width: "25px", height: "25px", padding: "12.5px", cursor: "pointer" }} />
                <BarChart onClick={() => setChosen(2)} style={{ alignSelf: "center", backgroundColor: chosen == 2 ? "#ccf" : "#fff", borderRadius: "20px", width: "25px", height: "25px", padding: "12.5px", cursor: "pointer" }} />
            </div>
